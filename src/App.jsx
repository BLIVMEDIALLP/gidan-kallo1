...
function SplashScreen({ onDone }) {
  ...
  return (
    <div style={{
      position:"fixed",inset:0,zIndex:9999,background:"#09090b",
      display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",
      opacity:fadeOut?0:1,transition:"opacity 0.6s ease-out",
      pointerEvents:fadeOut?"none":"all",
    }}>
      {IMAGES.splashGif ? (
        <img src={IMAGES.splashGif} alt="Loading" style={{width:180,height:180,objectFit:"contain",marginBottom:20}}
        ...
        <div style={{marginBottom:24}}>
          <div style={{
            ...
            <span style={{color:"#FFD700",fontWeight:900,fontSize:38,fontFamily:"serif"}}>GK</span>
          </div>
        </div>
      )}
      <div style={{color:"#FFD700",fontWeight:800,fontSize:22,letterSpacing:1,marginBottom:8}}>GIDAN KALLO</div>
      <div style={{color:"#6b7280",fontSize:13,letterSpacing:2}}>ENTERTAINMENT HUB</div>
      {/* Loading dots */}
...
const movies = [
  { id:1, title:"TSANDAURI", sub:"Divine Decree", genre:"Drama", duration:"2h 10m", lang:"Hausa / English", rating:4.7, badge:"FEATURED", badgeColor:"#a855f7", gradient:"linear-gradient(135deg,#1a0533,#4a0080,#6b00cc)", posterLetter:"T", poster:IMAGES.movies.TSANDAURI, banner:IMAGES.heroBanners.TSANDAURI, showtimes:[{time:"14:00",type:"Standard"},{time:"17:30",type:"VIP"},{time:"20:00",type:"Standard"}], dome:"Dome 1", price:2000 },
  { id:2, title:"KAMANNI", sub:"Seeking Justice", genre:"Action", duration:"1h 58m", lang:"English", rating:4.6, badge:"BLOCKBUSTER", badgeColor:"#f97316", gradient:"linear-gradient(135deg,#0f0c29,#302b63,#1a1a4e)", posterLetter:"H", poster:IMAGES.movies.KAMANNI, banner:IMAGES.heroBanners.KAMANNI, showtimes:[{time:"15:30",type:"IMAX"},{time:"18:00",type:"Standard"},{time:"21:30",type:"VIP"}], dome:"Dome 1", price:2000 },
  { id:3, title:"FANSA", sub:"Kamal Films International", genre:"Drama", duration:"2h 00m", lang:"Hausa", rating:4.5, badge:"NOW SHOWING", badgeColor:"#22c55e", gradient:"linear-gradient(135deg,#0d1f0d,#1a4a1a,#0a2e0a)", posterLetter:"R", poster:IMAGES.movies.FANSA, banner:IMAGES.heroBanners.FANSA, showtimes:[{time:"16:00",type:"Standard"},{time:"19:30",type:"VIP"}], dome:"Dome 1", price:2000 },
  { id:4, title:"Varanasi", sub:"SS Rajamouli", genre:"Epic", duration:"2h 45m", lang:"Telugu / Hindi / English", rating:4.9, badge:"EPIC", badgeColor:"#a855f7", gradient:"linear-gradient(135deg,#1a0a00,#7a3000,#c45000)", posterLetter:"V", poster:IMAGES.movies.varanasi, banner:IMAGES.heroBanners.varanasi, showtimes:[{time:"13:00",type:"IMAX"},{time:"17:00",type:"Standard"},{time:"21:00",type:"VIP"}], dome:"Dome 1", price:2000 },
];
...
const snackItems = [
  { id:"sp", name:"Small Popcorn", desc:"Freshly popped, butter or plain", price:1500, icon:"🍿", img:IMAGES.snacks.smallPopcorn },
  { id:"lp", name:"Large Popcorn", desc:"Shareable size with extra butter", price:3000, icon:"🍿", img:IMAGES.snacks.largePopcorn },
  { id:"cn", name:"Cheesy Nachos", desc:"Tortilla chips with melted cheese & salsa", price:3500, icon:"🧀", img:IMAGES.snacks.nachos },
  { id:"bb", name:"Beef Burger", desc:"Double patty with chips", price:4200, icon:"🍔", img:IMAGES.snacks.beefBurger },
  { id:"sl", name:"Slushie", desc:"Blue Raspberry / Strawberry", price:1500, icon:"🥤", img:IMAGES.snacks.slushy },
  { id:"pc", name:"Popcorn Combo", desc:"Large Popcorn + Drink", price:3500, icon:"🎉", img:IMAGES.snacks.popcornCombo },
];

const canteen = [
  { name:"Popcorn Combo", desc:"Large Popcorn + Drink", price:"₦3,500", color:"#FFD700", img:IMAGES.canteen.popcornCombo },
  { name:"Beef Burger", desc:"Double Patty + Chips", price:"₦4,200", color:"#f97316", img:IMAGES.canteen.beefBurger },
  { name:"Slushie", desc:"Blue Raspberry", price:"₦1,500", color:"#3b82f6", img:IMAGES.canteen.slushy },
];
...
const foodMenu = {
  "Nigerian Classics": [
    { id:"f1", name:"Suya Platter", desc:"Spicy grilled beef skewers with onions & yaji", size:"Small (4 sticks)", price:3500, emoji:"🍢", img:IMAGES.foodMenu.suyaPlatter, badge:"Bestseller", badgeColor:"#f97316" },
    { id:"f2", name:"Pounded Yam + Egusi Soup", desc:"With assorted meats & fish", size:"Serves 1–2", price:4800, emoji:"🍲", img:IMAGES.foodMenu.poundedYam, badge:null },
    { id:"f3", name:"Jollof Rice Special", desc:"Smoky party jollof with chicken", size:"Regular", price:3200, emoji:"🍛", img:IMAGES.foodMenu.jollofRice, badge:"Fan Fave", badgeColor:"#FFD700" },
    { id:"f4", name:"Pepper Soup", desc:"Goat / Chicken / Catfish — spicy & aromatic", size:"Medium bowl", price:3800, emoji:"🍵", img:IMAGES.foodMenu.pepperSoup, badge:null },
    { id:"f5", name:"Asun", desc:"Spicy barbecued goat meat", size:"Small portion", price:4200, emoji:"🥩", img:IMAGES.foodMenu.asun, badge:null },
  ],
  "Indo-Nigerian Fusion": [
    { id:"f6", name:"Beef Burger", desc:"Double patty with chips & coleslaw", size:"Double Patty + Chips", price:4200, emoji:"🍔", img:IMAGES.foodMenu.beefBurger, badge:"Bestseller", badgeColor:"#f97316" },
    { id:"f7", name:"Chicken Shawarma", desc:"Grilled chicken, veggies, garlic sauce in wrap", size:"Full wrap", price:2800, emoji:"🌯", img:IMAGES.foodMenu.shawarma, badge:null },
    { id:"f8", name:"Coconut Rice + Grilled Fish", desc:"Fragrant coconut rice with whole tilapia", size:"Serves 1", price:4500, emoji:"🐟", img:IMAGES.foodMenu.coconutRice, badge:"Fan Fave", badgeColor:"#FFD700" },
    { id:"f9", name:"Spaghetti Jollof", desc:"Spaghetti cooked in rich tomato pepper sauce", size:"Regular", price:2500, emoji:"🍝", img:IMAGES.foodMenu.spaghettiJollof, badge:null },
  ],
  "Cinema Snacks": [
    { id:"f10", name:"Popcorn Combo", desc:"Large Popcorn + your choice of drink", size:"Large", price:3500, emoji:"🍿", img:IMAGES.foodMenu.popcornCombo, badge:"Popular", badgeColor:"#a855f7" },
    { id:"f11", name:"Small Popcorn", desc:"Freshly popped, butter or plain", size:"Small", price:1500, emoji:"🍿", img:IMAGES.foodMenu.smallPopcorn, badge:null },
    { id:"f12", name:"Large Popcorn", desc:"Shareable size with extra butter", size:"Large", price:3000, emoji:"🍿", img:IMAGES.foodMenu.largePopcorn, badge:null },
    { id:"f13", name:"Cheesy Nachos", desc:"Tortilla chips with melted cheese & salsa", size:"Regular", price:3500, emoji:"🧀", img:IMAGES.foodMenu.nachos, badge:null },
    { id:"f14", name:"Slushy", desc:"Blue Raspberry / Strawberry / Mango", size:"Large cup", price:1500, emoji:"🥤", img:IMAGES.foodMenu.slushy, badge:null },
    { id:"f15", name:"Hot Dog", desc:"Beef frankfurter in toasted bun with toppings", size:"Single", price:2000, emoji:"🌭", img:IMAGES.foodMenu.hotDog, badge:null },
  ],
};
...
function TurfPage({ setPage, onBook }) {
  ...
  const turfs = [
    { id:1, name:"Green Turf Court", type:"Football", size:"5-a-Side", players:"Up to 20 players", price:30000, duration:"90 minutes", features:["⚽ Artificial Grass","💡 Floodlights","🚿 Changing Rooms","🅿️ Free Parking"], color:"#22c55e", slots:turfSlots, img:IMAGES.turf.greenTurf },
    { id:2, name:"Arena Pitch B", type:"Football", size:"7-a-Side", players:"Up to 14 players", price:25000, duration:"90 minutes", features:["⚽ Artificial Grass","💡 Floodlights","🚿 Changing Rooms"], color:"#3b82f6", slots:turfSlots.slice(1), img:IMAGES.turf.arenaPitch },
  ];
      ...
      <div style={{padding:"0 16px"}}>
        ...
        <div style={{background:"#18181b",borderRadius:20,overflow:"hidden",border:"1px solid #27272a",marginBottom:16}}>
          <div style={{height:100,position:"relative",display:"flex",alignItems:"center",padding:16,gap:12,overflow:"hidden"}}>
            <img src={IMAGES.turf.greenTurf} alt="Turf" style={{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover"}}/>
  ...
  return (
    <div style={{paddingBottom:120}}>
      ...
      <div style={{margin:"0 16px 16px",borderRadius:16,position:"relative",overflow:"hidden",border:"1px solid rgba(236,72,153,0.2)",height:120}}>
        <img src={selCat===0?IMAGES.games.snooker:IMAGES.games.ps5vr} alt={selCat===0?"Snooker":"Gaming"} style={{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover"}}/>
  ...
  return (
    <div style={{paddingBottom:80,background:"#09090b",minHeight:"100vh"}}>
      ...
      <div style={{padding:"0 16px"}}>
        ...
        <div style={{background:"#18181b",borderRadius:20,overflow:"hidden",border:"1px solid #27272a",marginBottom:16}}>
          <div style={{height:100,position:"relative",display:"flex",alignItems:"center",padding:16,gap:12,overflow:"hidden"}}>
            <img src={booking.category==="Snooker Table"?IMAGES.games.snooker:IMAGES.games.ps5vr} alt={booking.category} style={{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover"}}/>
            <div style={{position:"absolute",inset:0,background:"linear-gradient(to right,rgba(0,0,0,0.85),rgba(0,0,0,0.3))"}}/>
            <div style={{position:"relative",zIndex:1}}>
...
function FoodPage({ setPage, cart, setCart }) {
  ...
  const todaySpecial = { title:"Couple Date Night", sub:"Bundle — Save ₦2,000 tonight", bg:"linear-gradient(135deg,#1a0a00,#7a2000)", emoji:"🕯️", img:IMAGES.food.todaySpecial };
    ...
    <div style={{paddingBottom:80,background:"#09090b",minHeight:"100vh"}}>
      ...
      <div style={{padding:"0 16px"}}>
        ...
        <div style={{background:"#18181b",borderRadius:20,overflow:"hidden",border:"1px solid #27272a",marginBottom:16}}>
          {/* Header */}
          <div style={{height:100,position:"relative",display:"flex",alignItems:"center",padding:16,gap:12,overflow:"hidden"}}>
            <img src={IMAGES.food.orderHeader} alt="Food" style={{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover"}}/>
            <div style={{position:"absolute",inset:0,background:"linear-gradient(to right,rgba(0,0,0,0.85),rgba(0,0,0,0.3))"}}/>
            <div style={{position:"relative",zIndex:1}}>
...
function HomePage({ setPage, reviews, onRateClick, onSeeAll }) {
  ...
  return (
    <div style={{paddingBottom:r.isMobile?80:100}}>
      ...
      <div style={{margin:`0 ${p}px`,borderRadius:r.isMobile?18:24,overflow:"hidden",position:"relative",height:r.isDesktop?420:r.isTablet?340:280}}>
        <div style={{width:"100%",height:"100%",position:"relative",background:hero.gradient}}>
          <img src={hero.banner||hero.poster} alt={hero.title} style={{
            position:"absolute",
            right:0,top:0,
            width:r.isDesktop?"50%":r.isTablet?"60%":"100%",
            height:"100%",
            objectFit:"cover",
            objectPosition:"top center",
          }} onError={e=>{e.target.style.display="none"}}/>
          <div style={{position:"absolute",inset:0,background:r.isMobile
            ?"linear-gradient(to top,rgba(0,0,0,0.92) 0%,rgba(0,0,0,0.3) 45%,transparent 100%)"
            :`linear-gradient(to right,rgba(0,0,0,0.95) 0%,rgba(0,0,0,0.75) ${r.isDesktop?"40%":"30%"},transparent ${r.isDesktop?"70%":"65%"})`
          }}/>
          <div style={{position:"absolute",top:12,left:12,display:"flex",alignItems:"center",gap:6,background:"rgba(0,0,0,0.55)",borderRadius:20,padding:"5px 10px",zIndex:2}}>
            <GKLogo size={16}/><span style={{color:"#FFD700",fontSize:9,fontWeight:700,letterSpacing:2}}>GIDAN KALLO</span>
          </div>
          <div style={{position:"absolute",top:12,right:12,background:hero.badgeColor,color:"white",fontSize:r.isMobile?10:12,fontWeight:700,padding:"3px 10px",borderRadius:6,zIndex:2}}>{hero.badge}</div>
          <div style={{position:"absolute",bottom:r.isDesktop?96:76,left:r.isDesktop?30:14,display:"flex",gap:5,zIndex:2}}>
          ...
          <div style={{position:"absolute",bottom:r.isDesktop?24:12,left:r.isDesktop?30:14,right:r.isMobile?14:"auto",maxWidth:r.isDesktop?"42%":r.isTablet?"50%":"100%",zIndex:2}}>
            {!r.isMobile && <div style={{color:hero.badgeColor,fontSize:11,fontWeight:700,letterSpacing:1,marginBottom:6,textTransform:"uppercase"}}>{hero.badge} • {hero.genre}</div>}
            <div style={{color:"white",fontWeight:700,fontSize:r.isDesktop?32:r.isTablet?26:22,lineHeight:1.2,marginBottom:r.isDesktop?8:4}}>{hero.title}</div>
            <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:r.isDesktop?16:10}}><Stars count={Math.floor(hero.rating)} size={r.isMobile?13:15}/><span style={{color:"#9ca3af",fontSize:r.isMobile?12:14}}>• {hero.duration} • {hero.genre}</span></div>
            {!r.isMobile && <div style={{color:"#9ca3af",fontSize:13,marginBottom:16,lineHeight:1.4}}>{hero.lang}</div>}
            <button onClick={()=>setPage("cinema")} style={{width:r.isMobile?"100%":"auto",padding:r.isDesktop?"13px 56px":r.isTablet?"12px 40px":"11px",background:"white",color:"black",border:"none",borderRadius:10,fontWeight:700,fontSize:r.isMobile?14:16,cursor:"pointer"}}>🎟 Get Tickets</button>
          </div>
        </div>
      </div>
      ...
      <div style={{padding:`0 ${p}px ${p}px`}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:r.isDesktop?"1fr 1fr":"none",gap:r.isDesktop?16:0}}>
          {!r.isDesktop && <div style={{display:"flex",gap:12,overflowX:"auto",paddingBottom:4}}>
            {[{img:IMAGES.home.turfA,badge:null,dot:"#22c55e",dotLabel:"AVAILABLE NOW",title:"5-a-Side Turf A",sub:"Starting from ₦5,000/hr"},{img:IMAGES.home.turfB,badge:{label:"TOURNAMENT",color:"#f97316"},dot:null,dotLabel:null,title:"Weekend League",sub:"Register your team"}].map((c,i)=>(
          ...
          {r.isDesktop && [{img:IMAGES.home.turfA,badge:null,dot:"#22c55e",dotLabel:"AVAILABLE NOW",title:"5-a-Side Turf A",sub:"Starting from ₦5,000/hr"},{img:IMAGES.home.turfB,badge:{label:"TOURNAMENT",color:"#f97316"},dot:null,dotLabel:null,title:"Weekend League",sub:"Register your team"}].map((c,i)=>(
      ...
      <div style={{padding:`0 ${p}px ${p}px`}}>
        <div onClick={()=>setPage("games")} style={{borderRadius:r.isMobile?14:18,overflow:"hidden",position:"relative",height:r.isMobile?140:170,cursor:"pointer"}}>
          <img src={IMAGES.home.gamesLounge} alt="Games Lounge" style={{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover"}}/>
